...
namespace FinanceAnalyzer.Strategy
{
    ...
    public abstract class IFinanceStrategy
    {
        ...
        public abstract ICollection<StockOper> GetOper(int day, IAccount account);
        ...
        protected static bool CheckStock(IStockData stock, int day)
        {
            if (stock == null)
            {
                StrategyLog.DebugFormat("ERROR: Cannot find Stock Property of date: {0}!", day);
                return false;
            }
            else
            {
