...
namespace FinanceAnalyzer.Strategy.Impl
{
    ...
    class StrategyIndicator : IFinanceStrategy
    {
        ...
        public override ICollection<StockOper> GetOper(int dt, IAccount account)
        {
            //DateTime yesterday = stockHistory.GetDay(dt);
            ...
            OperType operType = _Calc.MatchSignal(dt, dt - 1);
