...
namespace FinanceAnalyzer.Stock
{
    ...
    public class Account : IAccount
    {
        ...
        private void BuyStocks(StockOper oper)
        {
            ...
            {
                bankRoll_ -= charge;
                double costPrice = charge / oper.HandCount;
                Holder.BuyStock(oper.HandCount, costPrice);
        ...
        /// <returns>总市值</returns>
        public double TotalValue(int dateIndex)
        {
            return Holder.MarketValue(dateIndex) + bankRoll_;
        }
